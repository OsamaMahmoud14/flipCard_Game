        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Image.asset("assets/animals/winner.png"),
                const SizedBox(
                  height: 30,
                ),
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text:
                        "You've successfully completed the Flutter memory game ",
                        style: const TextStyle(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>FlipCardPage()));
                  },
